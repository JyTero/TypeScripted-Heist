...
import { InitialisationManager as InitialisationManagerr } from "./Tools/InitialisationManager";
...
export const InitialisationManager:InitialisationManagerr = new InitialisationManagerr();
